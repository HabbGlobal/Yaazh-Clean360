...
export const WASTE_TYPES = ["recyclable","organic","hazardous","glass","chemical","electronic","other"] as const;
...
export const CollectionSchedule = models.CollectionSchedule || model<ICollectionSchedule>("CollectionSchedule",schema);
